...
public class ProductPriceResultsRecord extends UpdatableRecordImpl<ProductPriceResultsRecord> implements Record10<Long, String, String, BigDecimal, String, LocalDateTime, Double, Double, Double, Double> {
     ...
     */
    public void setModelPrediction(Double value) {
        set(9, value);
    }
    ...
    @Override
    public Row10<Long, String, String, BigDecimal, String, LocalDateTime, Double, Double, Double, Double> valuesRow() {
    ...
    @Override
    public ProductPriceResultsRecord value10(Double value) {
        setModelPrediction(value);
        return this;
    }

    @Override
    public ProductPriceResultsRecord values(Long value1, String value2, String value3, BigDecimal value4, String value5, LocalDateTime value6, Double value7, Double value8, Double value9, Double value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProductPriceResultsRecord(Long id, String productId, String productName, BigDecimal price, String currency, LocalDateTime timestamp, Double demandMetric, Double competitorPrice, Double inventoryLevel, Double modelPrediction) {
        super(ProductPriceResults.PRODUCT_PRICE_RESULTS);
